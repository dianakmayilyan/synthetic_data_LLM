...
class SyntheticDataEvaluator:
    ...
    def mle(self, target_column: list, task_type: str = 'classification'):
        ...
        # concatenating the training dataset and the synthetic dataset, training on them and testing on the original X_test and y_test
        X_combined = pd.concat([X_train_orig, X_synth], axis=0)
        y_combined = pd.concat([y_train_orig, y_synth], axis=0)
        ...
        results = {'Model': [], 'Original Data': [], 'Synthetic Data': [], 'Original and Synthetic Data': []}
        ...
        for model_name, model in models.items():
            ...
            results['Original and Synthetic Data'].append(score)
    ...
    # Machine Learning Efficiency
    def mle_xgb(self, target_column: list, task_type: str = 'classification'):
    ...
    def dm(self):
        ...
        X_combined = shuffled_data.drop(columns = ['label'])
        y_combined = shuffled_data['label']
    ...
    def dm_xgb(self):
        ...
        rf = XGBClassifier(use_label_encoder=False, eval_metrics='logloss')
        param_grid = {
        'n_estimators': [50, 100, 200],
        'max_depth': [5, 10, 20],
        'min_samples_split': [2, 5, 10]
